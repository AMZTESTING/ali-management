    ...
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        <Route
          path="/barista"
          element={
            <ProtectedRoute permission="barista">
              <Barista />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/cashier"
          element={
            <ProtectedRoute permission="cashier">
              <Cashier />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute permission="payment-methods">
              <PaymentMethods />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/ingredients"
          element={
            <ProtectedRoute permission="ingredients">
              <Ingredients />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/units"
          element={
            <ProtectedRoute permission="units">
              <Units />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/stock-movement"
          element={
            <ProtectedRoute permission="stock-movement">
              <StockMovements />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute permission="inventory-analytics">
              <InventoryAnalytics />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/discounts"
          element={
            <ProtectedRoute permission="discounts">
              <Discounts />
            </ProtectedRoute>
          }
        />
